...
public class Triggers extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 1532432822;
     ...
     */
    public final TableField<Record, String> TRIGGER_CATALOG = createField(DSL.name("TRIGGER_CATALOG"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.TRIGGERS.TRIGGER_SCHEMA</code>.
     */
    public final TableField<Record, String> TRIGGER_SCHEMA = createField(DSL.name("TRIGGER_SCHEMA"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.TRIGGERS.TRIGGER_NAME</code>.
     */
    public final TableField<Record, String> TRIGGER_NAME = createField(DSL.name("TRIGGER_NAME"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.TRIGGERS.TRIGGER_TYPE</code>.
     */
    public final TableField<Record, String> TRIGGER_TYPE = createField(DSL.name("TRIGGER_TYPE"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");
     ...
     */
    public final TableField<Record, Boolean> BEFORE = createField(DSL.name("BEFORE"), org.jooq.impl.SQLDataType.BOOLEAN, this, "");
     ...
     */
    public final TableField<Record, Integer> QUEUE_SIZE = createField(DSL.name("QUEUE_SIZE"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.TRIGGERS.NO_WAIT</code>.
     */
    public final TableField<Record, Boolean> NO_WAIT = createField(DSL.name("NO_WAIT"), org.jooq.impl.SQLDataType.BOOLEAN, this, "");
