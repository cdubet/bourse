...
public class Constants extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 1750511673;
     ...
     */
    public final TableField<Record, String> CONSTANT_CATALOG = createField(DSL.name("CONSTANT_CATALOG"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.CONSTANTS.CONSTANT_SCHEMA</code>.
     */
    public final TableField<Record, String> CONSTANT_SCHEMA = createField(DSL.name("CONSTANT_SCHEMA"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.CONSTANTS.CONSTANT_NAME</code>.
     */
    public final TableField<Record, String> CONSTANT_NAME = createField(DSL.name("CONSTANT_NAME"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");
