...
public class Help extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 1546945326;
     ...
     */
    public final TableField<Record, String> SECTION = createField(DSL.name("SECTION"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.HELP.TOPIC</code>.
     */
    public final TableField<Record, String> TOPIC = createField(DSL.name("TOPIC"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.HELP.SYNTAX</code>.
     */
    public final TableField<Record, String> SYNTAX = createField(DSL.name("SYNTAX"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.HELP.TEXT</code>.
     */
    public final TableField<Record, String> TEXT = createField(DSL.name("TEXT"), org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");
