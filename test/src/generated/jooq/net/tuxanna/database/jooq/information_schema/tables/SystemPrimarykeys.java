...
public class SystemPrimarykeys extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -804940253;
     ...
     */
    public final TableField<Record, String> TABLE_CAT = createField(DSL.name("TABLE_CAT"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "catalog in which table containing primary key is defined");
     ...
     */
    public final TableField<Record, String> TABLE_SCHEM = createField(DSL.name("TABLE_SCHEM"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "schema in which table containing primary key is defined");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_PRIMARYKEYS.TABLE_NAME</code>. simple name of table containing primary key
     */
    public final TableField<Record, String> TABLE_NAME = createField(DSL.name("TABLE_NAME"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "simple name of table containing primary key");
     ...
     */
    public final TableField<Record, String> COLUMN_NAME = createField(DSL.name("COLUMN_NAME"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "simple name of column participating in primary key");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_PRIMARYKEYS.KEY_SEQ</code>. sequence number of column within primary key
     */
    public final TableField<Record, Short> KEY_SEQ = createField(DSL.name("KEY_SEQ"), org.jooq.impl.SQLDataType.SMALLINT, this, "sequence number of column within primary key");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_PRIMARYKEYS.PK_NAME</code>. primary key name
     */
    public final TableField<Record, String> PK_NAME = createField(DSL.name("PK_NAME"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "primary key name");
