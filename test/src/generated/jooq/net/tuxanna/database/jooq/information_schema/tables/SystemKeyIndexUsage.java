...
public class SystemKeyIndexUsage extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 1023600072;
     ...
     */
    public final TableField<Record, String> INDEX_CATALOG = createField(DSL.name("INDEX_CATALOG"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_KEY_INDEX_USAGE.INDEX_SCHEMA</code>.
     */
    public final TableField<Record, String> INDEX_SCHEMA = createField(DSL.name("INDEX_SCHEMA"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
