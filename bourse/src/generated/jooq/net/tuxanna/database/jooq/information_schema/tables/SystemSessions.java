...
public class SystemSessions extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 421723197;
     ...
     */
    public final TableField<Record, Long> SESSION_ID = createField(DSL.name("SESSION_ID"), org.jooq.impl.SQLDataType.BIGINT, this, "session identifier");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.CONNECTED</code>. time at which session connected to database
     */
    public final TableField<Record, LocalDateTime> CONNECTED = createField(DSL.name("CONNECTED"), org.jooq.impl.SQLDataType.LOCALDATETIME, this, "time at which session connected to database");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.USER_NAME</code>. name of session user, as known to the database
     */
    public final TableField<Record, String> USER_NAME = createField(DSL.name("USER_NAME"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "name of session user, as known to the database");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.IS_ADMIN</code>. is session user an admin user?
     */
    public final TableField<Record, Boolean> IS_ADMIN = createField(DSL.name("IS_ADMIN"), org.jooq.impl.SQLDataType.BOOLEAN, this, "is session user an admin user?");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.AUTOCOMMIT</code>. is session in autocommit mode?
     */
    public final TableField<Record, Boolean> AUTOCOMMIT = createField(DSL.name("AUTOCOMMIT"), org.jooq.impl.SQLDataType.BOOLEAN, this, "is session in autocommit mode?");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.READONLY</code>. is session in read-only mode?
     */
    public final TableField<Record, Boolean> READONLY = createField(DSL.name("READONLY"), org.jooq.impl.SQLDataType.BOOLEAN, this, "is session in read-only mode?");
     ...
     */
    public final TableField<Record, Long> LAST_IDENTITY = createField(DSL.name("LAST_IDENTITY"), org.jooq.impl.SQLDataType.BIGINT, this, "what is the last identity value used by this session?");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.SCHEMA</code>. this session's current default schema
     */
    public final TableField<Record, String> SCHEMA = createField(DSL.name("SCHEMA"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "this session's current default schema");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.TRANSACTION</code>.
     */
    public final TableField<Record, Boolean> TRANSACTION = createField(DSL.name("TRANSACTION"), org.jooq.impl.SQLDataType.BOOLEAN, this, "");
     ...
     */
    public final TableField<Record, Long> TRANSACTION_SIZE = createField(DSL.name("TRANSACTION_SIZE"), org.jooq.impl.SQLDataType.BIGINT, this, "how many undo items are there in this session's transaction buffer?");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.WAITING_FOR_THIS</code>.
     */
    public final TableField<Record, String> WAITING_FOR_THIS = createField(DSL.name("WAITING_FOR_THIS"), org.jooq.impl.SQLDataType.VARCHAR(65536), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.THIS_WAITING_FOR</code>.
     */
    public final TableField<Record, String> THIS_WAITING_FOR = createField(DSL.name("THIS_WAITING_FOR"), org.jooq.impl.SQLDataType.VARCHAR(65536), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.CURRENT_STATEMENT</code>.
     */
    public final TableField<Record, String> CURRENT_STATEMENT = createField(DSL.name("CURRENT_STATEMENT"), org.jooq.impl.SQLDataType.VARCHAR(65536), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SESSIONS.LATCH_COUNT</code>.
     */
    public final TableField<Record, Long> LATCH_COUNT = createField(DSL.name("LATCH_COUNT"), org.jooq.impl.SQLDataType.BIGINT, this, "");
