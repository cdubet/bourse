...
public class SystemTypeinfo extends TableImpl<Record> {
    ...
    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.TYPE_NAME</code>. the
    ...
    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.PRECISION</code>. The
     * maximum column size for this data type.  For numeric data, this is the
     * maximum precision.  For string data, this is the length in characters. 
     * For datetime data types, this is the length in characters of the string
     * representation (assuming the maximum allowed precision of the fractional
     * seconds component).  NULL for data types where column size is not
     * applicable.  For interval data types, this is the number of characters in
     * the character representation of the interval literal (as defined by the
     * interval leading precision).
     */
    public final TableField<Record, Integer> PRECISION = createField(DSL.name("PRECISION"), SQLDataType.INTEGER, this, "The maximum column size for this data type.  For numeric data, this is the maximum precision.  For string data, this is the length in characters.  For datetime data types, this is the length in characters of the string representation (assuming the maximum allowed precision of the fractional seconds component).  NULL for data types where column size is not applicable.  For interval data types, this is the number of characters in the character representation of the interval literal (as defined by the interval leading precision).");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.LITERAL_PREFIX</code>. the
     * character or characters used to prefix a literal of this type; for
    ...
    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.LITERAL_SUFFIX</code>. the
     * character or characters used to terminate a literal of this type; for
     * example, a single quotation mark (') for character data types; NULL for
     ...
     * that may be specified in parentheses when issuing DDL relative to the
     * data type.  The keywords in the list, in the language of the current
     * Locale, may be any of the following:  length, precision, scale.  They
     * appear in the order that the syntax requires that they be used.  For
     * example, CREATE_PARAMS for DECIMAL with an English locale would be
     * "precision,scale"; CREATE_PARAMS for VARCHAR would be "length".  The
     ...
     * values allowed for this type?: { No Nulls | Nullable | Unknown }
     */
    public final TableField<Record, Short> NULLABLE = createField(DSL.name("NULLABLE"), SQLDataType.SMALLINT, this, "NULL values allowed for this type?: { No Nulls | Nullable | Unknown }");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.CASE_SENSITIVE</code>. TRUE if
     * the type is case-sensitive in collations and comparisons; FALSE otherwise
     */
    public final TableField<Record, Boolean> CASE_SENSITIVE = createField(DSL.name("CASE_SENSITIVE"), SQLDataType.BOOLEAN, this, "TRUE if the type is case-sensitive in collations and comparisons; FALSE otherwise");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.SEARCHABLE</code>.
     * use of WHERE?: { None | Char (Only WHERE .. LIKE) | Basic (Except WHERE
     * .. LIKE) | Searchable (All forms of WHERE...) }
     */
    public final TableField<Record, Integer> SEARCHABLE = createField(DSL.name("SEARCHABLE"), SQLDataType.INTEGER, this, "use of WHERE?: { None | Char (Only WHERE .. LIKE) | Basic (Except WHERE .. LIKE) | Searchable (All forms of WHERE...) }");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.UNSIGNED_ATTRIBUTE</code>. TRUE
     * if the data type is unsigned; NULL the attribute is not applicable to the
     * data type or the data type is not numeric.
     */
    public final TableField<Record, Boolean> UNSIGNED_ATTRIBUTE = createField(DSL.name("UNSIGNED_ATTRIBUTE"), SQLDataType.BOOLEAN, this, "TRUE if the data type is unsigned; NULL the attribute is not applicable to the data type or the data type is not numeric.");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.FIXED_PREC_SCALE</code>. TRUE if
     * the data type has predefined fixed precision and scale , like a money
     * data type.  NULL for non-numeric types.
     */
    public final TableField<Record, Boolean> FIXED_PREC_SCALE = createField(DSL.name("FIXED_PREC_SCALE"), SQLDataType.BOOLEAN, this, "TRUE if the data type has predefined fixed precision and scale , like a money data type.  NULL for non-numeric types.");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.AUTO_INCREMENT</code>. NULL if
     * the attribute is not applicable to the data type or the data type is not
     * numeric.  If TRUE, this indicates that when an insert is made, a unique
     * value is inserted into the column at insert time. The increment is not
     * defined. An application should not assume that auto-increment values
     * start at any particular point or increment by any particular value.
     */
    public final TableField<Record, Boolean> AUTO_INCREMENT = createField(DSL.name("AUTO_INCREMENT"), SQLDataType.BOOLEAN, this, "NULL if the attribute is not applicable to the data type or the data type is not numeric.  If TRUE, this indicates that when an insert is made, a unique value is inserted into the column at insert time. The increment is not defined. An application should not assume that auto-increment values start at any particular point or increment by any particular value.");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.LOCAL_TYPE_NAME</code>.
     * Localized version of the name of the data type; NULL if a localized name
     ...
     */
    public final TableField<Record, Short> MINIMUM_SCALE = createField(DSL.name("MINIMUM_SCALE"), SQLDataType.SMALLINT, this, "minimum scale supported");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.MAXIMUM_SCALE</code>.
     * maximum scale supported
     */
    public final TableField<Record, Short> MAXIMUM_SCALE = createField(DSL.name("MAXIMUM_SCALE"), SQLDataType.SMALLINT, this, "maximum scale supported");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.SQL_DATA_TYPE</code>.
     * The value of the SQL data type as it would appear in the SQL CLI
     * SQL_DESC_TYPE field of the SQLDA.
     */
    public final TableField<Record, Integer> SQL_DATA_TYPE = createField(DSL.name("SQL_DATA_TYPE"), SQLDataType.INTEGER, this, "The value of the SQL data type as it would appear in the SQL CLI SQL_DESC_TYPE field of the SQLDA.");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.SQL_DATETIME_SUB</code>. When
     * the value of SQL_DATA_TYPE is SQL_DATETIME or SQL_INTERVAL, this column
     * contains the datetime/interval subcode.  For data types other than
     * datetime and interval, this column is NULL.
     */
    public final TableField<Record, Integer> SQL_DATETIME_SUB = createField(DSL.name("SQL_DATETIME_SUB"), SQLDataType.INTEGER, this, "When the value of SQL_DATA_TYPE is SQL_DATETIME or SQL_INTERVAL, this column contains the datetime/interval subcode.  For data types other than datetime and interval, this column is NULL.");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.NUM_PREC_RADIX</code>. For
     ...
     * is NULL.
     */
    public final TableField<Record, Integer> NUM_PREC_RADIX = createField(DSL.name("NUM_PREC_RADIX"), SQLDataType.INTEGER, this, "For numeric types, this column contains the value 10 to indicate that COLUMN_SIZE specifies a number of decimal digits.  Otherwise, this column is NULL.");

    /**
     * The column
     * <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO.INTERVAL_PRECISION</code>. if
     * the data type is an interval data type, then this column contains the
     * value of the interval leading precision.  Otherwise, this column is NULL.
     */
    public final TableField<Record, Integer> INTERVAL_PRECISION = createField(DSL.name("INTERVAL_PRECISION"), SQLDataType.INTEGER, this, "if the data type is an interval data type, then this column contains the value of the interval leading precision.  Otherwise, this column is NULL.");
    ...
    /**
     * Create an aliased <code>INFORMATION_SCHEMA.SYSTEM_TYPEINFO</code> table
     * reference
     */
