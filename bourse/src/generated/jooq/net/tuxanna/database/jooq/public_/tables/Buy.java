...
public class Buy extends TableImpl<Record> {
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.SYS_PK_10152;
    }

    @Override
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.asList(Keys.SYS_FK_10157, Keys.SYS_FK_10158);
    }
    ...
    public Shares shares() {
        if (_shares == null)
            _shares = new Shares(this, Keys.SYS_FK_10157);
    ...
    public Account account() {
        if (_account == null)
            _account = new Account(this, Keys.SYS_FK_10158);
