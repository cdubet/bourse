...
public class SystemSequences extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SEQUENCE_CATALOG = createField(DSL.name("SEQUENCE_CATALOG"), net.tuxanna.database.jooq.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "sequence catalog name");
     ...
     */
    public final TableField<Record, String> SEQUENCE_SCHEMA = createField(DSL.name("SEQUENCE_SCHEMA"), net.tuxanna.database.jooq.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "sequence schema name");
     ...
     * identifier
     */
    public final TableField<Record, String> SEQUENCE_NAME = createField(DSL.name("SEQUENCE_NAME"), net.tuxanna.database.jooq.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "sequence identifier");
     ...
     * maximum value
     */
    public final TableField<Record, String> MAXIMUM_VALUE = createField(DSL.name("MAXIMUM_VALUE"), net.tuxanna.database.jooq.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "sequence maximum value");
     ...
     * minimum value
     */
    public final TableField<Record, String> MINIMUM_VALUE = createField(DSL.name("MINIMUM_VALUE"), net.tuxanna.database.jooq.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "sequence minimum value");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SEQUENCES.INCREMENT</code>.
     * sequence increment
     */
    public final TableField<Record, String> INCREMENT = createField(DSL.name("INCREMENT"), net.tuxanna.database.jooq.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "sequence increment");

    /**
     * The column <code>INFORMATION_SCHEMA.SYSTEM_SEQUENCES.CYCLE_OPTION</code>.
     * sequence cycle option ('YES' | 'NO')
     */
    public final TableField<Record, String> CYCLE_OPTION = createField(DSL.name("CYCLE_OPTION"), net.tuxanna.database.jooq.information_schema.Domains.YES_OR_NO.getDataType(), this, "sequence cycle option ('YES' | 'NO')");
     ...
     */
    public final TableField<Record, String> START_WITH = createField(DSL.name("START_WITH"), net.tuxanna.database.jooq.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "sequence start with value");
