...
public class TestDatabaseStorage
{
	...
	private ArrayList<ShareDB> fillWithTestShares()
	{
		...
		listSharesToWrite.add(new ShareDB(NAME1,TICKER1,ShareDB.Currency.EURO,TypeOfItem.SHARE));
		listSharesToWrite.add(new ShareDB(NAME2,TICKER2,ShareDB.Currency.EURO,TypeOfItem.SHARE));
		listSharesToWrite.add(new ShareDB(NAME3,TICKER3,ShareDB.Currency.EURO,TypeOfItem.SHARE));
		listSharesToWrite.add(new ShareDB(NAME4,TICKER4,ShareDB.Currency.EURO,TypeOfItem.SHARE));
		listSharesToWrite.add(new ShareDB(NAME5,TICKER5,ShareDB.Currency.EURO,TypeOfItem.SHARE));
