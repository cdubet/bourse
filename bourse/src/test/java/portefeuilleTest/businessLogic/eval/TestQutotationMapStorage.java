...
public class TestQutotationMapStorage
{
	...
	public void testGet()
	{
		...
		ShareDB share=new ShareDB(ID_SHARE_1,"share1","sh1",ShareDB.Currency.EURO,TypeOfItem.SHARE);
		ShareIdAndDate key1=new ShareIdAndDate(share,testTime);
		mapToTest.add(key1, NEW_PRICE_SHARE_1);

		ShareDB share2=new ShareDB(ID_SHARE_2,"share2","sh2",ShareDB.Currency.EURO,TypeOfItem.SHARE);
