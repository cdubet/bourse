...
public class FakeDatabase implements DatabaseI
{
	...
	void fillQuotationMapStorage(QuotationMapStorage mapToFill,Date now,Date yesterday, ShareNameStorage mapShareToFill)
	{
		...
		//fill now map
		{
			ShareDB share=new ShareDB(ID_SHARE_1,SHARE_NAME_1,"sh1",ShareDB.Currency.EURO,TickerI.TypeOfItem.TYPE_SHARE);
		...
		{
			ShareDB share=new ShareDB(ID_SHARE_2,SHARE_NAME_2,"sh2",ShareDB.Currency.EURO,TickerI.TypeOfItem.TYPE_SHARE);
			listShares.add(share);
			{
				ShareIdAndDate key1=new ShareIdAndDate(share,now);
		...
		{
			ShareDB share=new ShareDB(ID_SHARE_3,SHARE_NAME_3,"sh3",ShareDB.Currency.EURO,TickerI.TypeOfItem.TYPE_SHARE);
			listShares.add(share);
			{
				ShareIdAndDate key1=new ShareIdAndDate(share,now);
		...
		{
			ShareDB share=new ShareDB(ID_SHARE_4,SHARE_NAME_4,"sh4",ShareDB.Currency.EURO,TickerI.TypeOfItem.TYPE_SHARE);
			listShares.add(share);
			{
				ShareIdAndDate key1=new ShareIdAndDate(share,now);
