...
public class TestCsv
{
	...
	{
		final TypeOfItem typeShare=TypeOfItem.SHARE;//does not matter here
		final Currency currency=Currency.EURO;

		List<ShareDB> listShares=new ArrayList<>();
		ShareDB share1=new ShareDB(id_share1,name1,ticker1,currency,typeShare);
		listShares.add(share1);

		ShareDB share2=new ShareDB(id_share2,name2,ticker2,currency,typeShare);
