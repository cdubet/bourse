...
import net.tuxanna.portefeuille.businessLogic.shareOrders.SellManagement;
import net.tuxanna.portefeuille.businessLogic.shareOrders.ShareOrderManagementI;
...
public class PortfolioManagement
{
			...
			boolean addComparisonWithLastWeek)
	{
		...
		for (Iterator<Share> iterator = listShares.iterator(); iterator.hasNext();)
		{
			...
			{
				Quote storedQuote = listOfQuotationsDB.get(share.getShareDB()).getQuotation();
